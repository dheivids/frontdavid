export function controller() {
    ...
    /** Nodos del DOM */
         ...
         const btnSaludar-17 = document.querySelector('#btn-saludar')

    /** Manejadores de eventos */

         btnPedir.addEventListener('click', onPedir)
         btnSaludar.addEventListener('clcik', onSaludar)
         btnSaludar17.addEventListener('click', Await)
         
           
            /**
             * Una "Promesa" es un objeto nativo desde ES6
             * que representa la terminacion  o el fracaso enventual
             * de una operacion asincrona
             * 
             * Una promesa es un objeto devuelto 
             * al cual asocias las funciones de callback, en vez de pasar funciones callbacks una funcion
             */
